  ...
  const products = [
    {
      ...
      description: 'Классический сорт индики с расслабляющим эффектом. Идеален для вечернего использования. ТГК: 18-22%'
    },
    {
      name: 'Blue Dream',
      price: 3800,
      ...
      description: 'Популярный гибрид с балансом эффектов. Легкая эйфория и расслабление. ТГК: 17-24%'
    },
    {
      name: 'Sour Diesel',
      price: 4000,
      ...
      description: 'Энергичная сатива с цитрусовым ароматом. Отлично подходит для дневного использования. ТГК: 20-25%'
    },
    {
      name: 'OG Kush',
      price: 4200,
    ...
    },
    {
      ...
      description: 'Классический голландский гибрид с белым налетом. Сбалансированный эффект. ТГК: 18-25%'
    },
    {
    ...
    },
    {
      ...
      description: 'Высокое содержание CBD, минимум ТГК. Лечебные свойства без психоактивного эффекта. CBD: 15-20%, ТГК: <1%'
    },
    {
      name: 'Harlequin',
      price: 3200,
      ...
      description: 'Сбалансированное соотношение CBD/THC. Легкий эффект с лечебными свойствами. CBD: 8-16%, ТГК: 4-10%'
    },
    {
      name: 'Green Crack',
      price: 3900,
      ...
      description: 'Энергичная сатива для активного дня. Фруктовый вкус с нотками манго. ТГК: 15-25%'
    },
    {
      name: 'AK-47',
      price: 3800,
