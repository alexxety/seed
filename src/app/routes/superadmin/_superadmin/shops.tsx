    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-400">
          ...
          <span className="font-semibold text-white">{shops?.length || 0}</span> магазинов
        </p>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <h3 className="text-xl font-bold text-white">{shop.subdomain}.x-bro.com</h3>
                  ...
                  <div className="mt-4 flex gap-6 text-xs text-gray-500">
                    <div>Создан: {new Date(shop.createdAt).toLocaleDateString('ru-RU')}</div>
                    <div>Обновлён: {new Date(shop.updatedAt).toLocaleDateString('ru-RU')}</div>
                    {shop.expiresAt && (
