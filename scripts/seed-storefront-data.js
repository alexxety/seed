  ...
  await seedTenantStorefront('demo', {
    ...
    products: [
      ...
      },
      {
        name: 'Laptop Stand',
        description:
          'Ergonomic aluminum laptop stand with adjustable height. Improve your workspace.',
      ...
      },
      {
        ...
        description:
          'RGB mechanical keyboard with custom switches. Perfect for gamers and typists.',
        category: 'Electronics',
    ...
    products: [
      {
        ...
        description:
          'Premium organic coffee beans sourced from sustainable farms. Rich aroma and smooth taste.',
      ...
      },
      {
        name: 'Yoga Mat',
        description:
          'Non-slip eco-friendly yoga mat with extra cushioning. Perfect for all types of yoga.',
        category: 'Sports',
      ...
      },
      {
        ...
        description:
          'Insulated water bottle keeps drinks cold for 24h or hot for 12h. BPA-free and durable.',
        category: 'Accessories',
